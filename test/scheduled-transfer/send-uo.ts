import { ADDRESS, formatUserOpFromHex, getUserOpHashV07, packUserOp, RpcProvider, type FormattedUserOp } from '@/index'
import { getBundlerUrl } from '../../test/utils'

const bundlerUrl = getBundlerUrl(11155111n, { type: 'pimlico' })

const formattedUserOp: FormattedUserOp = {
...
const userOp = formatUserOpFromHex(formattedUserOp)

console.log('packUserOp', packUserOp(userOp))

const userOpHash = getUserOpHashV07(packUserOp(userOp), 11155111n)
