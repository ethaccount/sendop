...
export interface EntryPointV08Interface extends Interface {
  getFunction(
    nameOrSignature:
      | "addStake"
      | "balanceOf"
...
export interface EntryPointV08 extends BaseContract {
  connect(runner?: ContractRunner | null): EntryPointV08;
  waitForDeployment(): Promise<this>;

  interface: EntryPointV08Interface;
