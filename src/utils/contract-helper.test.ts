...
describe('Contract Helper', () => {
	it('parseContractError', async () => {
		...
		expect(result).toBe('Registry.NoTrustedAttestersFound')
		...
		expect(result2).toBe('SmartSession.InvalidISessionValidator(0x0000002D6DB27c52E3C11c1Cf24072004AC75cBa)')
	})
})
