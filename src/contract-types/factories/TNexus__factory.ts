...
import type { TNexus, TNexusInterface } from "../TNexus";
...
export class TNexus__factory {
  static readonly abi = _abi;
  static createInterface(): TNexusInterface {
    return new Interface(_abi) as TNexusInterface;
  }
  static connect(address: string, runner?: ContractRunner | null): TNexus {
    return new Contract(address, _abi, runner) as unknown as TNexus;
  }
}
