...
import type {
  TNexusBootstrap,
  TNexusBootstrapInterface,
} from "../TNexusBootstrap";
...
export class TNexusBootstrap__factory {
  static readonly abi = _abi;
  static createInterface(): TNexusBootstrapInterface {
    return new Interface(_abi) as TNexusBootstrapInterface;
  }
  static connect(
    address: string,
    runner?: ContractRunner | null
  ): TNexusBootstrap {
    return new Contract(address, _abi, runner) as unknown as TNexusBootstrap;
  }
}
