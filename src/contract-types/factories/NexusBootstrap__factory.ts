...
export class NexusBootstrap__factory {
  static readonly abi = _abi;
  static createInterface(): NexusBootstrapInterface {
    return new Interface(_abi) as NexusBootstrapInterface;
  }
  static connect(
    address: string,
    runner?: ContractRunner | null
  ): NexusBootstrap {
    return new Contract(address, _abi, runner) as unknown as NexusBootstrap;
  }
}
