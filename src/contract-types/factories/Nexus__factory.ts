...
import type { Nexus, NexusInterface } from "../Nexus";
...
export class Nexus__factory {
  static readonly abi = _abi;
  static createInterface(): NexusInterface {
    return new Interface(_abi) as NexusInterface;
  }
  static connect(address: string, runner?: ContractRunner | null): Nexus {
    return new Contract(address, _abi, runner) as unknown as Nexus;
  }
}
