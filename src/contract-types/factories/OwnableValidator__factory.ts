...
import type {
  OwnableValidator,
  OwnableValidatorInterface,
} from "../OwnableValidator";
...
export class OwnableValidator__factory {
  static readonly abi = _abi;
  static createInterface(): OwnableValidatorInterface {
    return new Interface(_abi) as OwnableValidatorInterface;
  }
  static connect(
    address: string,
    runner?: ContractRunner | null
  ): OwnableValidator {
    return new Contract(address, _abi, runner) as unknown as OwnableValidator;
  }
}
