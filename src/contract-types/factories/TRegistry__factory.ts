...
import type { TRegistry, TRegistryInterface } from "../TRegistry";
...
export class TRegistry__factory {
  static readonly abi = _abi;
  static createInterface(): TRegistryInterface {
    return new Interface(_abi) as TRegistryInterface;
  }
  static connect(address: string, runner?: ContractRunner | null): TRegistry {
    return new Contract(address, _abi, runner) as unknown as TRegistry;
  }
}
