...
import type { TSmartSession, TSmartSessionInterface } from "../TSmartSession";
...
export class TSmartSession__factory {
  static readonly abi = _abi;
  static createInterface(): TSmartSessionInterface {
    return new Interface(_abi) as TSmartSessionInterface;
  }
  static connect(
    address: string,
    runner?: ContractRunner | null
  ): TSmartSession {
    return new Contract(address, _abi, runner) as unknown as TSmartSession;
  }
}
