...
import type { SmartSession, SmartSessionInterface } from "../SmartSession";
...
export class SmartSession__factory {
  static readonly abi = _abi;
  static createInterface(): SmartSessionInterface {
    return new Interface(_abi) as SmartSessionInterface;
  }
  static connect(
    address: string,
    runner?: ContractRunner | null
  ): SmartSession {
    return new Contract(address, _abi, runner) as unknown as SmartSession;
  }
}
