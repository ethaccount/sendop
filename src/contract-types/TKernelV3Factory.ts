...
export interface TKernelV3FactoryInterface extends Interface {
  getFunction(
...
export interface TKernelV3Factory extends BaseContract {
  connect(runner?: ContractRunner | null): TKernelV3Factory;
  waitForDeployment(): Promise<this>;

  interface: TKernelV3FactoryInterface;
