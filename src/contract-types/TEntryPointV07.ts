...
export interface TEntryPointV07Interface extends Interface {
  getFunction(
    nameOrSignature:
      | "addStake"
      | "balanceOf"
...
export interface TEntryPointV07 extends BaseContract {
  connect(runner?: ContractRunner | null): TEntryPointV07;
  waitForDeployment(): Promise<this>;

  interface: TEntryPointV07Interface;
