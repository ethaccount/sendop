...
export interface TSimpleAccountFactoryV08Interface extends Interface {
  getFunction(
    nameOrSignature:
...
export interface TSimpleAccountFactoryV08 extends BaseContract {
  connect(runner?: ContractRunner | null): TSimpleAccountFactoryV08;
  waitForDeployment(): Promise<this>;

  interface: TSimpleAccountFactoryV08Interface;
