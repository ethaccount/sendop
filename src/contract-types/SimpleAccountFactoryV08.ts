...
export interface SimpleAccountFactoryV08Interface extends Interface {
  getFunction(
    nameOrSignature:
...
export interface SimpleAccountFactoryV08 extends BaseContract {
  connect(runner?: ContractRunner | null): SimpleAccountFactoryV08;
  waitForDeployment(): Promise<this>;

  interface: SimpleAccountFactoryV08Interface;
