...
export interface TEntryPointV08Interface extends Interface {
  getFunction(
    nameOrSignature:
      | "addStake"
      | "balanceOf"
...
export interface TEntryPointV08 extends BaseContract {
  connect(runner?: ContractRunner | null): TEntryPointV08;
  waitForDeployment(): Promise<this>;

  interface: TEntryPointV08Interface;
  ...
  getDomainSeparatorV4: TypedContractMethod<[], [string], "view">;
  ...
  getPackedUserOpTypeHash: TypedContractMethod<[], [string], "view">;
  ...
  >;
  getFunction(
    nameOrSignature: "getDomainSeparatorV4"
  ...
  >;
  getFunction(
    nameOrSignature: "getPackedUserOpTypeHash"
  ): TypedContractMethod<[], [string], "view">;
  getFunction(
