...
export interface TSmartSessionInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "areActionsEnabled"
...
export interface TSmartSession extends BaseContract {
  connect(runner?: ContractRunner | null): TSmartSession;
  waitForDeployment(): Promise<this>;

  interface: TSmartSessionInterface;
