...
export interface TRegistryInterface extends Interface {
  getFunction(
    nameOrSignature:
...
export interface TRegistry extends BaseContract {
  connect(runner?: ContractRunner | null): TRegistry;
  waitForDeployment(): Promise<this>;

  interface: TRegistryInterface;
