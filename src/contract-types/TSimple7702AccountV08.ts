...
export interface TSimple7702AccountV08Interface extends Interface {
  getFunction(
    nameOrSignature:
      | "entryPoint"
      | "execute"
...
export interface TSimple7702AccountV08 extends BaseContract {
  connect(runner?: ContractRunner | null): TSimple7702AccountV08;
  waitForDeployment(): Promise<this>;

  interface: TSimple7702AccountV08Interface;
