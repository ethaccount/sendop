...
export interface TNexusBootstrapInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "eip712Domain"
      | "getActiveHook"
...
export interface TNexusBootstrap extends BaseContract {
  connect(runner?: ContractRunner | null): TNexusBootstrap;
  waitForDeployment(): Promise<this>;

  interface: TNexusBootstrapInterface;
