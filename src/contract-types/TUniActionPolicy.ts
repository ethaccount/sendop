...
export interface TUniActionPolicyInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "actionConfigs"
      | "checkAction"
...
export interface TUniActionPolicy extends BaseContract {
  connect(runner?: ContractRunner | null): TUniActionPolicy;
  waitForDeployment(): Promise<this>;

  interface: TUniActionPolicyInterface;
