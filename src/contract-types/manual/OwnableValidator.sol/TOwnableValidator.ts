...
export interface TOwnableValidatorInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "addOwner"
      | "getOwners"
...
export namespace ModuleUninitializedEvent {
  export type InputTuple = [account: AddressLike];
  export type OutputTuple = [account: string];
  export interface OutputObject {
    account: string;
...
export interface TOwnableValidator extends BaseContract {
  connect(runner?: ContractRunner | null): TOwnableValidator;
  waitForDeployment(): Promise<this>;

  interface: TOwnableValidatorInterface;
  ...
  >;
  getEvent(
    key: "ModuleUninitialized"
  ): TypedContractEvent<
    ModuleUninitializedEvent.InputTuple,
    ModuleUninitializedEvent.OutputTuple,
    ModuleUninitializedEvent.OutputObject
  >;
  getEvent(
    key: "OwnerAdded"
  ): TypedContractEvent<
  ...
  filters: {
    ...
    "ModuleUninitialized(address)": TypedContractEvent<
      ModuleUninitializedEvent.InputTuple,
      ModuleUninitializedEvent.OutputTuple,
      ModuleUninitializedEvent.OutputObject
    >;
    ModuleUninitialized: TypedContractEvent<
      ModuleUninitializedEvent.InputTuple,
      ModuleUninitializedEvent.OutputTuple,
      ModuleUninitializedEvent.OutputObject
    >;

    "OwnerAdded(address,address)": TypedContractEvent<
      OwnerAddedEvent.InputTuple,
      OwnerAddedEvent.OutputTuple,
      OwnerAddedEvent.OutputObject
    >;
    ...
    "OwnerRemoved(address,address)": TypedContractEvent<
      OwnerRemovedEvent.InputTuple,
      OwnerRemovedEvent.OutputTuple,
      OwnerRemovedEvent.OutputObject
    >;
    ...
    "ThresholdSet(address,uint256)": TypedContractEvent<
      ThresholdSetEvent.InputTuple,
      ThresholdSetEvent.OutputTuple,
      ThresholdSetEvent.OutputObject
    >;
