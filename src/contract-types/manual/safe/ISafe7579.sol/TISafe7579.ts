...
export interface TISafe7579Interface extends Interface {
  getFunction(
    nameOrSignature:
      | "accountId"
      | "domainSeparator"
...
export interface TISafe7579 extends BaseContract {
  connect(runner?: ContractRunner | null): TISafe7579;
  waitForDeployment(): Promise<this>;

  interface: TISafe7579Interface;
