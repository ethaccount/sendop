...
export interface TSafeProxyFactoryInterface extends Interface {
  getFunction(
    nameOrSignature:
...
export interface TSafeProxyFactory extends BaseContract {
  connect(runner?: ContractRunner | null): TSafeProxyFactory;
  waitForDeployment(): Promise<this>;

  interface: TSafeProxyFactoryInterface;
