...
export interface TISafeInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "VERSION"
      | "checkSignatures"
...
export interface TISafe extends BaseContract {
  connect(runner?: ContractRunner | null): TISafe;
  waitForDeployment(): Promise<this>;

  interface: TISafeInterface;
