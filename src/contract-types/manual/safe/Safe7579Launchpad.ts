...
export interface Safe7579LaunchpadInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "REGISTRY"
...
export interface Safe7579Launchpad extends BaseContract {
  connect(runner?: ContractRunner | null): Safe7579Launchpad;
  waitForDeployment(): Promise<this>;

  interface: Safe7579LaunchpadInterface;
