...
export interface TIExecutorInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "isInitialized"
      | "isModuleType"
...
export interface TIExecutor extends BaseContract {
  connect(runner?: ContractRunner | null): TIExecutor;
  waitForDeployment(): Promise<this>;

  interface: TIExecutorInterface;
