...
export interface TIFallbackInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "isInitialized"
      | "isModuleType"
...
export interface TIFallback extends BaseContract {
  connect(runner?: ContractRunner | null): TIFallback;
  waitForDeployment(): Promise<this>;

  interface: TIFallbackInterface;
