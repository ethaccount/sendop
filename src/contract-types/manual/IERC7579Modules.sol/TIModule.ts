...
export interface TIModuleInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "isInitialized"
      | "isModuleType"
...
export interface TIModule extends BaseContract {
  connect(runner?: ContractRunner | null): TIModule;
  waitForDeployment(): Promise<this>;

  interface: TIModuleInterface;
