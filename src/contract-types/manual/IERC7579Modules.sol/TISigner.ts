...
export interface TISignerInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "checkSignature"
...
export interface TISigner extends BaseContract {
  connect(runner?: ContractRunner | null): TISigner;
  waitForDeployment(): Promise<this>;

  interface: TISignerInterface;
