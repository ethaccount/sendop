...
export interface TIPolicyInterface extends Interface {
  getFunction(
    nameOrSignature:
...
export interface TIPolicy extends BaseContract {
  connect(runner?: ContractRunner | null): TIPolicy;
  waitForDeployment(): Promise<this>;

  interface: TIPolicyInterface;
