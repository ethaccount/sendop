...
export interface IERC7579AccountViewInterface extends Interface {
  getFunction(
...
export interface IERC7579AccountView extends BaseContract {
  connect(runner?: ContractRunner | null): IERC7579AccountView;
  waitForDeployment(): Promise<this>;

  interface: IERC7579AccountViewInterface;
