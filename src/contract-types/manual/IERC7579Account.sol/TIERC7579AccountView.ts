...
export interface TIERC7579AccountViewInterface extends Interface {
  getFunction(
...
export interface TIERC7579AccountView extends BaseContract {
  connect(runner?: ContractRunner | null): TIERC7579AccountView;
  waitForDeployment(): Promise<this>;

  interface: TIERC7579AccountViewInterface;
