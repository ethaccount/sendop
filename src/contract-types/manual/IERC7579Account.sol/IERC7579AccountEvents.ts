...
export interface IERC7579AccountEventsInterface extends Interface {
  getEvent(
...
export interface IERC7579AccountEvents extends BaseContract {
  connect(runner?: ContractRunner | null): IERC7579AccountEvents;
  waitForDeployment(): Promise<this>;

  interface: IERC7579AccountEventsInterface;
