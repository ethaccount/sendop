...
export interface ERC20SpendingLimitPolicyInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "checkAction"
...
export interface ERC20SpendingLimitPolicy extends BaseContract {
  connect(runner?: ContractRunner | null): ERC20SpendingLimitPolicy;
  waitForDeployment(): Promise<this>;

  interface: ERC20SpendingLimitPolicyInterface;
